...
# ╔═╡ f93a5bbc-8a1a-11ed-164b-c53f2e4c1f13
begin
	using DataFrames
	using Plots
	using StatsBase
	...
	function plot_results(window, correlations)
		...
		Plots plot
		"""
		p = plot(plot(correlations), plot(window), layout = (2, 1))
		return(p)
	end
...
# ╔═╡ be1ec285-b869-4d3f-b3ce-5af79722e73c


# ╔═╡ ae4b2745-83f4-4526-9bdb-575f0898772a


# ╔═╡ 9e167e57-2398-4995-87d4-6d3861a8d59a
plot_results(window, correlations)

# ╔═╡ c0b69ae5-2476-4781-b2e1-55c994957673
plot_results2(window, correlations, good_maxima, Int(62))

# ╔═╡ 233d7458-331c-4c33-8bad-15304e00fcf3
print(length(good_maxima[2]))

# ╔═╡ 45109fbc-488b-4ded-af6a-d3122c0d1a39
begin
a = [1, 1, 3, 5, 3, 2]
findmax(a)
end

# ╔═╡ 1570f0bf-2ac8-4008-8315-a05b40bc7f4a
findmax(good_maxima[1])
...
julia_version = "1.8.4"
manifest_format = "2.0"
project_hash = "5f3cd3b9e60a112fb5b81a9cbf4212800bce6a10"
